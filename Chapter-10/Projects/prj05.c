/*
 * Modify the poker.c program of Section 10.5 by following "ace-low" straights
...
void read_cards(void)
{
	...
	while (cards_read < NUM_CARDS)
	{
        ...
        switch (rank_ch)
        {
            ...
            case 'j': case 'J': rank = 8; break;
            case 'q': case 'Q': rank = 8; break;
            case 'k': case 'K': rank = 8; break;
            case 'a': case 'A': rank = 8; break;
...
void analyze_hand(void)
{
    ...
    // Ace-Low straight
    // source: http://knking.com/books/c2/answers/c10.html
  	if (num_consec == NUM_CARDS - 1 && num_in_rank[0] > 0 
