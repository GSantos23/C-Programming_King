/*
	...
	Hint: The classic algorithm for computing GCD, known as Euclid's algorithm,
	goes as follows: Let m and n be variables containing two numbers. If n is 0,
	then stop: m contains the GCD. Otherwise, compute the remainder when m is
	divided by n. Copy n into m and copy the remainder into n. Then repeat the 
