/*
	...
	Hint: This program ins't hard as it looks. The most important part is a
	...
	loop, an if statement test wheter i is the last day in a week; 
...
int main(void)
{
	...
	printf("%*s", (space-1)*3, "");		// To allow space before first day
